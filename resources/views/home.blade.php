                            ...
                            <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
                                        <img src="{{ asset('dashboard_assests') }}/images/avatar/1.jpg" class="rounded-circle user_img_msg"
                                            alt="" />
                                    </div>
                                ...
                                <div class="d-flex justify-content-end mb-4">
                                    ...
                                    <div class="img_cont_msg">
                                        <img src="{{ asset('dashboard_assests') }}/images/avatar/2.jpg" class="rounded-circle user_img_msg"
                                            alt="" />
                                    </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
                                        ...
                                        <div class="testimonial-one owl-carousel">
                                            <div class="items">
                                                <div class="card text-center">
                                                    <div class="card-body">
                                                        <img src="{{ asset('dashboard_assests') }}/images/testimonial/1.jpg" alt="">
                                            ...
                                            <div class="items">
                                                <div class="card text-center">
                                                    <div class="card-body">
                                                        <img src="{{ asset('dashboard_assests') }}/images/testimonial/2.jpg" alt="">
                                                        <h5 class="fs-16 font-w500 mb-1"><a href="app-profile.html"
                                            ...
                                            <div class="items">
                                                <div class="card text-center">
                                                    <div class="card-body">
                                                        <img src="{{ asset('dashboard_assests') }}/images/testimonial/3.jpg" alt="">
                                                        <h5 class="fs-16 font-w500 mb-1"><a href="app-profile.html"
                                            ...
                                            <div class="items">
                                                <div class="card text-center">
                                                    <div class="card-body">
                                                        <img src="{{ asset('dashboard_assests') }}/images/testimonial/4.jpg" alt="">
                                                        <h5 class="fs-16 font-w500 mb-1"><a href="app-profile.html"
                                ...
                                <div class="card featuredMenu">
                                    ...
                                    <div class="card-body loadmore-content height750 dz-scroll pt-0"
                                        ...
                                        <div class="media mb-4">
                                            <img src="{{ asset('dashboard_assests') }}/images/menus/1.png" width="85" alt=""
                                                class="rounded mr-3">
                                            <div class="media-body">
                                        ...
                                        <div class="media mb-4">
                                            <img src="{{ asset('dashboard_assests') }}/images/menus/2.png" width="85" alt=""
                                                class="rounded mr-3">
                                            <div class="media-body">
                                                <h5><a href="food-menu.html" class="text-black fs-16">Fresh or
                                                        Frozen (No Sugar Added) Fruits</a></h5>
                                        ...
                                        <div class="media mb-4">
                                            <img src="{{ asset('dashboard_assests') }}/images/menus/3.png" width="85" alt=""
                                                class="rounded mr-3">
                                            <div class="media-body">
                                                <h5><a href="food-menu.html" class="text-black fs-16">Fresh or
                                                        Frozen (No Sugar Added) Fruits</a></h5>
                                        ...
                                        <div class="media mb-4">
                                            <img src="{{ asset('dashboard_assests') }}/images/menus/4.png" width="85" alt=""
                                                class="rounded mr-3">
                                            <div class="media-body">
                                                <h5><a href="food-menu.html" class="text-black fs-16">Original
                                                        Boiled Egg with Himalaya Salt</a></h5>
